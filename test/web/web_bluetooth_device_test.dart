...
void main() {
  ...
  test("Should parse basic jsObject", () {
    final Map<String, dynamic> jsObject = {"id": "SOME-ID"};

    expect(() => WebBluetoothDevice.fromJSObject(jsObject), returnsNormally);
  });

  test("Should throw error missing id", () {
    final Map<String, dynamic> jsObject = {};

    expect(() => WebBluetoothDevice.fromJSObject(jsObject),
